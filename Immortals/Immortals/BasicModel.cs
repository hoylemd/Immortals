...
{
    /// <summary>
    /// Class to hold information about a basic model
    /// </summary>
    class BasicModel
    {
        ...
        /// <summary>
        /// Overrideable accessor for world
        /// </summary>
        /// <returns> this model's World matrix</returns>
        ...
        /// <summary>
        /// Empty Update function for overriding
        /// </summary>
        public virtual void Update() { }

        /// <summary>
        /// Function to draw this model
        /// </summary>
        ...
        /// <summary>
        /// Function to determine if two models have collided
        /// </summary>
        /// <param name="otherModel"> The other Model to check</param>
        /// <param name="otherWorld"> The other model's world transformation</param>
        /// <returns></returns>
